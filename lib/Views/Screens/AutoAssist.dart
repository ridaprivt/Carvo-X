          ...
          children: [
            ...
            InkWell(
              ...
              child: Center(
                child: Container(
                  padding:
                      EdgeInsets.symmetric(vertical: 13.sp, horizontal: 18.sp),
                  decoration: BoxDecoration(
    ...
    List<Map<String, dynamic>> messages = [
      {
        'role': 'user',
        'content':
            '''Give Answer for following query/issue/concern/tips/questions if it is related to cars or automotive industry . If its not about them tell user that u only can assist related to cars
        $bot.text
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData.containsKey("result") &&
          ...
          String sol = responseData["result"]["response"].toString();
          Get.to(BotResponse(ans: sol));
          setState(() {
            print('Generated Suggestion: $sol');
          });
        } else {
